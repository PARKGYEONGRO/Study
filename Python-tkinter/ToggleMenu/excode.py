...
def toggle_win():
    ...
    bttn(0,80,'HOME','#0f9d9a','#12c4c0',home)
    bttn(0,117,'ListSeting','#0f9d9a','#12c4c0',acer)
    bttn(0,154,'1','#0f9d9a','#12c4c0',dell)
    bttn(0,191,'2','#0f9d9a','#12c4c0',None)
    bttn(0,228,'3','#0f9d9a','#12c4c0',None)
    bttn(0,265,'CLOSE','#0f9d9a','#12c4c0',close)
